...
from smd.online_fix import apply_multiplayer_fix as apply_online_fix
...
class GameHandler:
    ...
    def manage_dlc_unlockers(self, app_info: ACFInfo) -> None:
        ...
        """
        from smd.dlc_unlockers.manager import UnlockerManager
        from smd.dlc_unlockers.downloader import GitHubReleaseDownloader
        from smd.dlc_unlockers.base import Platform, UnlockerType
        from smd.storage.settings import get_setting, set_setting
        import asyncio
